...
function BackgroundVideo() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-start justify-center left-1/2 opacity-25 top-0 w-[1920px]" data-name="Background Video">
      <EzlArb9VzjWiQcbvg1D25VSqXs0Svg />
    </div>
  );
}

function EzlArb9VzjWiQcbvg1D25VSqXs0Svg() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 w-full" data-name="EzlARB9VZJWiQcbvg1D25vSqXS0.svg">
      <div className="h-[2136px] overflow-clip relative shrink-0 w-[1920px]" data-name="Component 1">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1920 2136">
          <path d="M0 0H1920V2136H0V0Z" fill="var(--fill-0, black)" id="Vector" />
        </svg>
      </div>
    </div>
  );
